...
{top: 30, right: 30, bottom: 0, left: 330}
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["flare-2.json", {url: new URL("./files/file1.json", import.meta.url), mimeType: null, toString}]
  ]);
  main.builtin("FileAttachment", runtime.fileAttachments(name => fileAttachments.get(name)));
  main.variable(observer()).define(["md"], _1);
  main.variable(observer("chart")).define("chart", ["d3","width","height","x","root","up","xAxis","yAxis","down"], _chart);
  main.variable("bar").define("bar", ["margin","barStep","barPadding","x"], _bar);
  main.variable("down").define("down", ["d3","duration","bar","stack","stagger","x","xAxis","barStep","color"], _down);
  main.variable("up").define("up", ["duration","x","d3","xAxis","stagger","stack","color","bar","down","barStep"], _up);
  main.variable("stack").define("stack", ["x","barStep"], _stack);
  main.variable("stagger").define("stagger", ["x","barStep"], _stagger);
  main.variable("root").define("root", ["d3","data"], _root);
  main.variable("data").define("data", ["FileAttachment"], _data);
  main.variable("x").define("x", ["d3","margin","width"], _x);
  main.variable("xAxis").define("xAxis", ["margin","d3","x","width"], _xAxis);
  main.variable("yAxis").define("yAxis", ["margin","height"], _yAxis);
  main.variable("color").define("color", ["d3"], _color);
  main.variable("barStep").define("barStep", _barStep);
  main.variable("barPadding").define("barPadding", ["barStep"], _barPadding);
  main.variable("duration").define("duration", _duration);
  main.variable("height").define("height", ["root","barStep","margin"], _height);
